				...
				<div id="content">
					<div class="post">
						...
						<p class="meta">Posted by <a href="#"><?php echo $newsItem['author_name'];?></a> on <?php echo $newsItem['date'];?>
							&nbsp;&bull;&nbsp; <a href='/public/views/newsic/views/news' class="permalink"> Back to HomePage</a></p>
						<div class="entry">
							<p><img src="/template/images/pic01.jpg" width="800" height="300" alt="" /></p>
							<p><?php echo $newsItem['short_content'];?></p>
						</div>
					</div>
					<p><a href='/public/views/newsic/views/news' class="permalink"> Back to HomePage</a></p>
